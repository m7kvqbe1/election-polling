...
this["JST"]["VoteForm"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    ...
    + this.escapeExpression((helpers.buildOptions || (depth0 && depth0.buildOptions) || helpers.helperMissing).call(depth0,(depth0 != null ? depth0.constituencyOptions : depth0),{"name":"buildOptions","hash":{},"data":data}))
